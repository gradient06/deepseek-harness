...
/** French strings (same key set as the English source of truth). */
export const fr: Record<keyof typeof en, string> = {
  ...
  deleteDescription: 'La suppression de {provider} retire sa configuration. Toute identité de connexion qu’il utilise est gérée ailleurs et sera conservée.',
  deleteDescriptionWithCredential: 'La suppression de {provider} retire sa configuration et sa clé API stockée.',
  ...
  conflict: 'Quelqu’un a modifié ces paramètres pendant que cette carte était ouverte. Fermez-la et rouvrez-la pour modifier les valeurs actuelles.',
  retry: 'Réessayer',
  keyInput: 'Clé API',
  keyPlaceholder: 'Saisissez votre clé API',
  keyPlaceholderNative: 'Saisissez une clé API, ou laissez vide pour utiliser l’authentification par environnement',
  ...
  baseUrl: 'URL de base',
  baseUrlDefault: 'Défaut du fournisseur',
  models: 'Modèles',
  modelsInherited: 'Utilise les modèles par défaut de l’adaptateur',
  ...
  modelNamePlaceholder: 'Utilise l’ID du modèle quand le champ est vide',
  ...
  modelsEmpty: 'Aucun modèle ne sera affiché dans le sélecteur. Les ID non répertoriés peuvent toujours être envoyés directement.',
  keyBlank: 'Saisissez la clé API, ou laissez le champ vide pour conserver celle qui est stockée.',
  keyBlankNew: 'Saisissez la clé API, ou laissez le champ vide si ce fournisseur s’authentifie autrement.',
  keyIllegalCharacters: 'Cette clé API n’a pas un format valide. Veuillez la vérifier.',
  ...
  modelMaxTokensInvalid: 'Le nombre maximal de tokens de sortie doit être un nombre positif, comme 8192, 64K ou 1M.',
  advancedHint: 'Les autres champs se trouvent dans settings.yaml ; modifiez cette section directement.',
  modelCapacityInvalid: 'Une capacité doit être un nombre, éventuellement suffixé K ou M.',
  ...
  fetchEmpty: 'Le fournisseur n’a répertorié aucun modèle. Ajoutez-les manuellement.',
  ...
  customRouteHint: 'Identifiant en minuscules, commençant par une lettre, qui nomme ce fournisseur de manière unique dans les requêtes et comme nom d’identité de connexion.',
  customRouteInvalid: 'Commencez par une lettre minuscule ; ensuite lettres minuscules, chiffres et tirets.',
  ...
  welcomeError: 'La confirmation n’a pas pu être enregistrée. Veuillez réessayer.',
  onboardingTitle: 'Ajoutez une clé API pour commencer',
  onboardingDescription: 'Configurez le fournisseur officiel DeepSeek pour commencer à construire.',
