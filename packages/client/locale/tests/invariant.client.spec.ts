...
describe('invariant companion', () => {
  ...
  it('client apply provides ctx.locale seeded with the zh/en/fr common namespace', async () => {
    ...
    expect(() => (locale as LocaleRuntime).register(COMMON_NS, 'fr', {})).toThrow('already has locale')
  })
})
