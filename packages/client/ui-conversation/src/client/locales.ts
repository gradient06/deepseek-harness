...
export const zh = {
  ...
  'file.pick': '选择文件加入工作目录',
  'file.added': '📎 已加入工作目录：{files}',
  'file.uploaded.one': '已将 1 个文件加入工作目录',
  'file.uploaded.other': '已将 {count} 个文件加入工作目录',
  'file.uploadFailed': '{name} 写入失败：{reason}',
...
export const en = {
  ...
  'file.dropTitle': 'Drag files here to write them into this session\'s working directory',
  'file.dropDesc': 'Files are saved in this session\'s working directory, where the agent can read them',
  'file.pick': 'Choose files to add to the working directory',
  'file.added': '📎 Added to the working directory: {files}',
  'file.uploaded.one': 'Added 1 file to the working directory',
  'file.uploaded.other': 'Added {count} files to the working directory',
  'file.uploadFailed': 'Could not write {name}: {reason}',
...
export const fr = {
  ...
  'hint.goal.active': 'objectif en cours — edit / pause / resume / clear',
  ...
  'placeholder.parentOffline': 'Session parente hors ligne ; l’envoi est indisponible mais vous pouvez arrêter l’exécution',
  ...
  'placeholder.steerQueue': 'Cmd/Ctrl+Entrée insère et envoie tous les messages en file',
  ...
  'image.openOriginalLabel': '{label}, cliquer pour voir l’original',
  ...
  'image.sendFailed': 'Échec de l’envoi des images ({reason}) ; réajoutez-les et réessayez',
  'file.dropTitle': 'Glissez des fichiers ici pour les écrire dans le répertoire de travail de cette session',
  'file.dropDesc': 'Les fichiers sont enregistrés dans le répertoire de travail de cette session, où l’agent peut les lire',
  'file.pick': 'Choisir des fichiers à ajouter au répertoire de travail',
  'file.added': '📎 Ajouté au répertoire de travail : {files}',
  'file.uploaded.one': '1 fichier ajouté au répertoire de travail',
  'file.uploaded.other': '{count} fichiers ajoutés au répertoire de travail',
  'file.uploadFailed': 'Écriture de {name} impossible : {reason}',
  ...
  'settings.enter.title': 'Comportement d’Entrée quand l’agent est occupé',
  'settings.enter.description': 'Agent occupé uniquement ; Cmd/Ctrl+Entrée utilise l’autre comportement',
  'settings.enter.queue': 'Mettre en file',
  'settings.enter.steer': 'Insérer',
  'access.confirm.title': 'Activer Full access ?',
  'access.confirm.description': 'Full access réduit les étapes de confirmation et permet à l’agent d’effectuer directement davantage d’actions, y compris des opérations sensibles, des modifications de fichiers ou des commandes externes. Utilisez-le uniquement lorsque vous faites confiance à la tâche en cours.',
  ...
  'session.hierarchy': 'Hiérarchie de sessions',
  ...
  'message.context.instructions.removed': 'supprimées',
  'message.context.catalog.replaced': 'Catalogue de remplacement',
  'message.context.catalog.more': '… {count} de plus',
  'message.context.snapshot.supersedes': 'Remplace les instantanés antérieurs',
  'message.context.relay.from': 'De la session {session}',
  'message.context.recall.counts': '{retained} conservées · {omitted} omises',
  ...
  'message.compaction.expand': 'Voir le résumé de compression',
  'message.compaction.unavailable': 'Résumé de compression indisponible',
  ...
  'message.retry.active': 'Nouvelle tentative de la requête modèle',
  'message.retry.cancelled': 'Nouvelle tentative de la requête modèle annulée',
  'message.retry.started': 'Requête modèle relancée',
  'message.retry.scheduled': 'En attente de relance de la requête modèle',
  'message.retry.status': '{label} ({retry}/{maximum}) · {seconds}s',
  ...
  'message.maxTokens.hint': 'La réponse a été coupée ; la sortie précédente est conservée dans la conversation. Envoyez « continue » pour laisser le modèle reprendre.',
  ...
  'command.imagesUnsupported': '/{command} n’accepte pas les pièces jointes images ; retirez-les d’abord',
  ...
  'queue.steer': 'Insérer le message en file',
  'queue.steer.unavailable': 'L’insertion n’est disponible que lorsque l’agent est en cours d’exécution',
  'queue.editFailed': 'Échec de la modification : ce message a peut-être déjà commencé à partir.',
  'queue.removeFailed': 'Échec du retrait : ce message a peut-être déjà commencé à partir.',
  'queue.steerFailed': 'Échec de l’insertion. Réessayez.',
  'terminal.signal': 'signal {signal}',
  ...
  'terminal.expandAria': 'Déplier les {n} lignes de sortie restantes',
