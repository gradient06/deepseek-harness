...
export const fr = {
  ...
  'orderBy.updated': 'Récents',
  'sessions.expand': 'Afficher {n} sessions supplémentaires',
  ...
  'search.unavailable': 'La recherche de contenu est temporairement indisponible. Seuls les noms sont pris en compte.',
  ...
  'delete.desc': 'Cela retire « {name} » de la liste des espaces de travail. Le dossier et les journaux de sessions sont conservés ; ses sessions apparaîtront sous « Non groupé ».',
